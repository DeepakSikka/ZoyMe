...
public class ZoyMePrivacyListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zoy_me_privacy_list);
        ...
        toolbar_tv_title.setText("Privacy policy");
        ...
        toolbar_iv_cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent mIntent = new Intent(ZoyMePrivacyListActivity.this, ZoyMeCartActivity.class);
