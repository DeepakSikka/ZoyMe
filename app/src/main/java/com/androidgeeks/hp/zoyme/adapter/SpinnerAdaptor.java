 ...
 */
public class SpinnerAdaptor extends ArrayAdapter<SizeModel> {
    private Context context;
    private int resource;
    private SizeModel[] objects;
    private LayoutInflater inflater;


    public SpinnerAdaptor(Context context, int resource, SizeModel[] objects) {
